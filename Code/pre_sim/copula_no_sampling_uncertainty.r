################################################################################
################################################################################
# Script:       copula_modeling_calibration_no_bootstrap.R
...
#               binomial whose mean is drawn to carry survey sampling uncertainty,
#               but dispersion (theta) is fixed to the point estimate, omitting
...
here::i_am("Code/pre_sim/copula_no_sampling_uncertainty.R")
...
#'   Sampling uncertainty enters by drawing the NB mean (from its survey SE) on
#'   each of the n_draws. NB dispersion remains fixed based on point estimates.
